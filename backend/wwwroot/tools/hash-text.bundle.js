...
function hashText(input, encoding = "HEX") {
  ...
  const result = {
    ...
    SHA1: encodeResult(sha1(textBytes), encoding),
    SHA224: encodeResult(sha224(textBytes), encoding),
    SHA256: encodeResult(sha256(textBytes), encoding),
    SHA384: encodeResult(sha384(textBytes), encoding),
    SHA512: encodeResult(sha512(textBytes), encoding),
